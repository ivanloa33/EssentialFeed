...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith result: RemoteFeedLoader.FeedLoaderResult, action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
